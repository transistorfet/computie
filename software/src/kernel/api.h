...
extern ssize_t do_sendto(int fd, const void *buf, size_t n, int flags, const void *opts[2]);
...
extern ssize_t do_recvfrom(int fd, void *buf, size_t n, int flags, void *opts[2]);
